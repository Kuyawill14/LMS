                                    ...
                                    <v-list-item-content @click="ViewSubmision(item, i)">
                                     <v-list-item-title>
                                         ...
                                         <v-list-item-subtitle >
                                              <v-icon left small color="success" v-if="item.status == 'Submitted'">mdi-check</v-icon> 
                                              <span class="success--text"  v-if="item.status == 'Submitted'">Submitted</span>
                        ...
                        if(this.selectedStatus == "Submitted" ){
                            ...
                            Filterddata =  Filterddata.filter((item) => {
                                if(this.Class == this.$route.params.id){
                                    ...
                                    return ((item.status == null || item.status == '') && item.class_id == this.Class)
                                }
                            })
                            this.Submitted_count = Filterddata.length;
                            if(this.selectedSort == "Name"){
