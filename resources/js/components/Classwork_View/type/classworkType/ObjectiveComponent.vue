<template>
    ...
    <div>
        ...
        <v-row justify="center" align-content="center" no-gutters
                ...
                <v-card :class="$vuetify.breakpoint.mdAndUp ? 'pa-3' : 'pa-1'"
                    ...
                    <v-row>
                        <v-col v-if="$vuetify.breakpoint.mdAndUp" cols="12" class="mb-0 pb-0">
                            <v-tooltip top>
                                <template v-slot:activator="{ on, attrs }">
                                    <v-btn rounded v-bind="attrs" v-on="on" icon text class=""
                                        @click="$router.push({name: 'classwork'})">
                        ...
                        <v-col class="ma-0 pa-0">
                            ...
                            <v-divider></v-divider>
                            <v-list :max-height="$vuetify.breakpoint.mdAndUp ? '550' : '500'"
                                style="overflow-y:scroll;scrollbar-width: thin;" class="mb-0 pb-0">

                                <v-list-item class="mb-0 pb-0 mt-0 pt-0" v-for="(item, i) in classworkDetails.comments"
                                    :key="i">
                                ...
                                'https://ui-avatars.com/api/?background=random&color=fff&name=' +  item.name : item.profile_pic">
                                    ...
                                    <v-list-item-content>
                                        ...
                                        <v-alert v-else color="#F5F5F5" class="rounded-xl mt-0 mb-0">
                                            ...
                                            <v-list-item-subtitle class="mb-3">{{comment_date(item.comment_date)}}
            ...
            <v-col v-if="!isViewingSubmission" :class="!$vuetify.breakpoint.mdAndUp ? 'mt-1 pl-0 pt-1' : 'pt-0 pl-5'"
                        ...
                        <v-row>
                            ...
                            <v-col cols="12" class="">
                                <v-container ma-0 pa-0 class="d-flex flex-row justify-space-between">
                                    ...
                                    <div class="float-right mt-3" fab>
                                        <div class="text-md-h5">
                                            <v-icon large color="primary">mdi-book-clock-outline</v-icon>
                                            {{classworkDetails.duration}}
                                            {{classworkDetails.duration > 1 ? 'mins' : 'min'}}
                                        </div>
                            ...
                            <v-col cols="12" class="pl-7 pr-5">
                                <div class="text-sm-body-2 text-md-h5 text-lg-h6 text-xl-h6">{{classworkDetails.title}}
                                </div>

                                <div class="pt-2 d-flex flex-row ">
                                    <div class="captions">
                                        <v-icon>mdi-circle-medium</v-icon>{{totalQuestion}} Question
                                    </div>
                                    <div class="captions">
                                        <v-icon>mdi-circle-medium</v-icon>{{classworkDetails.points}} Points
                                    </div>
                                </div>
                                <v-divider></v-divider>
                            </v-col>
                            ...
                            <v-col cols="12" class="pl-10 pr-5 pb-5">
                                ...
                                <span class="text-sm-body-2 " style="max-width:98%"
                                    v-html="classworkDetails.instruction"></span>
                            </v-col>
                            <v-col v-if="classworkDetails.attachment != null" cols="12" class=" pb-5 pl-5 pr-5">
                                ...
                                <v-list class="ma-0 pa-0">
                                    <v-list-item v-for="(item, i) in classworkDetails.attachment" :key="i"
                                        class="ma-0 pa-0">
                                        <v-list-item-avatar>
                            ...
                            <v-col v-if="classworkDetails.availability == 0" cols="12"
                                ...
                                <v-btn :block="!$vuetify.breakpoint.mdAndUp "
                                    ...
                                    rounded color="primary" :loading="isOpenQuiz" :dark="totalQuestion != 0"
                                    :disabled="totalQuestion == 0" @click="continueQuiz(classworkDetails.id)">Continue
            ...
            <v-col v-else :class="!$vuetify.breakpoint.mdAndUp ? 'mt-1 pl-0 pt-1' : 'pt-0 pl-5'" cols="12" md="10"
                lg="8" xl="8">
                <vue-element-loading :active="isLoaded" spinner="bar-fade-scale" />
                <v-card :class="$vuetify.breakpoint.mdAndUp ? 'pa-3' : 'pa-1'"
