<template>
    <div>
        <v-dialog v-model="dialog" persistent max-width="45%">
         ...
         <v-row align="center" justify="center" class="pt-10" v-if="role == 'Teacher' && !isGetting && ClassworkLength == 0">
            <v-col cols="12" sm="8" md="4" class="text-center">
                ...
                <v-btn color="primary" @click="dialog = !dialog"> CREATE CLASS </v-btn>
            </v-col>
        </v-row>
        ...
        <v-container v-if="(!isGetting && ClassworkLength != 0) || role == 'Student'">
            <v-row>
                <v-col>
