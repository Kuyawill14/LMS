                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:30px;font-family:'Rubik',sans-serif;">Submitted work</h1>
                                        <p style="color:#455056; font-size:13px;line-height:24px; margin:0; margin-top:5px">
                                            <span style="font-weight: bold">{{$name}}</span>  Submitted in your  <span style="font-weight: bold"> {{$classwork_name}} classwork.</span> 
                                        </p>
                                        <div class="content" style="color:#455056; font-size:13px;; margin:0;margin-top:0px;">
                                         ...
                                         <div class="main_container" style="padding-left: 1rem" >
                                             ...
                                             <div style="margin-top: 18px;margin-left:10px">
                                                 ...
                                                 <span >Submitted </span> <span style="color: green">&#10003;</span><br>
                                                 <span style="font-weight:bold;">{{$date_sub}}</span>
                                             </div>
                                         </div>
                                        </div>
