...
class AnnouncementController extends Controller
{
    ...
    public function allClassPost($id)
    {
        ...
        if(auth('sanctum')->user()->role != 'Student')
        {
            ...
            ->select('tbl_classposts.id as post_id', 'tbl_classposts.class_id', 'tbl_class_announcements.id as announcement_id','tbl_class_announcements.*','tbl_user_details.profile_pic', DB::raw('CONCAT(users.firstname, " ", users.lastName) as name'))
