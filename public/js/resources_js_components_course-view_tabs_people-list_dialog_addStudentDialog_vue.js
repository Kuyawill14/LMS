          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (_this.getClassesNames.length == 0) {
                  _this.$store.dispatch('fetchClassesNames', _this.$route.params.id).then(function () {
                    _this.cl_id = _this.getClassesNames[0].class_id;
                    _this.classList = _this.getClassesNames.filter(function (item) {
                      return item.class_id != _this.$route.params.id;
                    });
                  });
                } else {
                  _this.cl_id = _this.getClassesNames[0].class_id;
