...
/* harmony export */ });
Object(function webpackMissingModule() { var e = new Error("Cannot find module './announcementCreate.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module './announcementPostList.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    announcementCreate: Object(function webpackMissingModule() { var e = new Error("Cannot find module './announcementCreate.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    VueElementLoading: (vue_element_loading__WEBPACK_IMPORTED_MODULE_1___default()),
    announcementPostList: Object(function webpackMissingModule() { var e = new Error("Cannot find module './announcementPostList.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
  data: function data() {
    return {
      content: '',
  ...
  return _c(
    ...
    [
      _c("vue-element-loading", { attrs: { active: !_vm.isLoading } }, [
        _c("img", {
          attrs: { src: _vm.loadingImg, width: "55px", height: "55px" }
        })
      ]),
      _vm._v(" "),
