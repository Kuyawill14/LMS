...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      DateToday: null,
      unfinishCount: 0,
      today: moment_timezone__WEBPACK_IMPORTED_MODULE_1___default()(new Date()).format('YYYY-MM-DD')
    };
  },
  mounted: function mounted() {
    this.getGeneralClassworks();
    var newDate = new Date();
    this.DateToday = moment_timezone__WEBPACK_IMPORTED_MODULE_1___default()(newDate).format('YYYY-MM-DD HH:mm:ss');
  },
  methods: {
    format_date: function format_date(value) {
      if (value) {
        return moment_timezone__WEBPACK_IMPORTED_MODULE_1___default()(String(value)).format('dddd, h:mm a');
      }
    },
              ...
              case 0:
                axios.get('/api/profile/mycalendar').then(function (res) {
                  ...
                  if (res.data.Classwork_sched.length != 0) {
                    var data = moment_timezone__WEBPACK_IMPORTED_MODULE_1___default()(_this.CalendarSched[0].from_date)._d;

                    for (var index = 0; index < _this.CalendarSched.length; index++) {
                      var test = moment_timezone__WEBPACK_IMPORTED_MODULE_1___default()(_this.CalendarSched[index].from_date);
                      var color = void 0;
                      var name = void 0;
                      ...
                      var check = moment_timezone__WEBPACK_IMPORTED_MODULE_1___default()(_this.CalendarSched[index].to_date).format('YYYY-MM-DD HH:mm');

                      if (check != 'Invalid date') {
                        events.push({
                          type: 'classwork',
                          name: name,
                          start: moment_timezone__WEBPACK_IMPORTED_MODULE_1___default()(_this.CalendarSched[index].to_date)._d,
                          end: null,
                          color: color,
                  ...
                  _this.setClassSched(res.data.class_sched);
                });
    ...
    setClassSched: function setClassSched(data) {
      var _this2 = this;

      data.forEach(function (item) {
        if (item.schedule != false) {
          item.schedule.forEach(function (element) {
            var tmpday = element.day.toLowerCase();
            var tmp_start = Date.parse('next ' + tmpday).at(element.start_time);
            var tmp_end = Date.parse('next ' + tmpday).at(element.end_time);
            var start = moment_timezone__WEBPACK_IMPORTED_MODULE_1___default()(tmp_start).format('YYYY-MM-DD HH:mm');
            var end = moment_timezone__WEBPACK_IMPORTED_MODULE_1___default()(tmp_end).format('YYYY-MM-DD HH:mm');
    ...
    CheckFormatDue: function CheckFormatDue(value) {
      if (value) {
        return moment_timezone__WEBPACK_IMPORTED_MODULE_1___default()(String(value)).format('YYYY-MM-DD HH:mm:ss');
      }
    }
  }
});
                    ...
                    [
                      _c(
                        ...
                        [
                          ...
                          _vm._v(" "),
                          _c("v-card-text", [
                            _vm.selectedEvent.type == "classwork"
                              ? _c("div", [
                                  _c(
                                    "span",
                                  ...
                                  _vm._v(
                                    " " +
                                      _vm._s(
                                        _vm.format_date(_vm.selectedEvent.end)
                                      )
                                  )
                                ])
                              : _vm._e(),
                            _vm._v(" "),
                            _vm.selectedEvent.type == "class_sched"
                              ? _c("div", [
                                  _c(
                                    "span",
                                    { staticClass: "font-weight-bold" },
                                  ...
                                  _c(
                                    ...
                                    [
                                      _vm._v(
                                        _vm._s(
                                          _vm.selectedEvent.display_start
                                        ) + " "
                                      )
                                    ]
                                  ),
                                  ...
                                  _c(
                                    ...
                                    [
                                      _vm._v(
                                        _vm._s(_vm.selectedEvent.display_end) +
                                          " "
                                      )
                                    ]
                                  )
