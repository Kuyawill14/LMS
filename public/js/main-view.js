            ...
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                messaging.requestPermission().then(function () {
                  ...
                  axios__WEBPACK_IMPORTED_MODULE_2___default().post('/api/store_token', {
                    token: response
                  }).then(function (res) {});
    ...
    [
      ...
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _vm.get_UserRole == "Student"
            ? _c(
                "v-dialog",
                {
                  attrs: { persistent: "", width: "570" },
                  model: {
                    value: _vm.get_evaluation_dialog,
                    callback: function($$v) {
                      _vm.get_evaluation_dialog = $$v
                    },
                    expression: "get_evaluation_dialog"
                  }
                },
                [
                  _c("evaluation", {
                    on: {
                      closeDialog: function($event) {
                        return _vm.setEvaluationDialog()
                      }
                    }
                  })
                ],
