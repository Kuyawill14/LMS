"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_Classwork_View_tabs_TeacherQuizPreview_StudentViewForTeacher_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Classwork_View/tabs/TeacherQuizPreview/StudentViewForTeacher.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Classwork_View/tabs/TeacherQuizPreview/StudentViewForTeacher.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    CloseDialog: function CloseDialog() {
      ...
      this.Question.Question.forEach(function (item) {
        if (item.type == 'Matching type') {
          _this.Question.Answer[counter].Destructors.forEach(function (des) {
            var tmp = 0;

            _this.Question.Answer[counter].SubAnswer.forEach(function (sub) {
              if (des.id == sub.id) {
                _this.Question.Answer[counter].SubAnswer.splice(tmp, 1);
              }
    ...
    SuffleQuestion: function SuffleQuestion() {
      ...
      this.QuestionList.forEach(function (item) {
        if (item.type == 'Multiple Choice' || item.type == 'Matching type') {
          _this3.Question.Answer.forEach(function (element) {
    ...
    LoadDestructor: function LoadDestructor() {
      ...
      this.Question.Question.forEach(function (item) {
        if (item.type == 'Matching type') {
          _this4.Question.Answer[counter].Destructors.forEach(function (des) {
            _this4.Question.Answer[counter].SubAnswer.push(des);
          });
        }
...
/***/ "./resources/js/components/Classwork_View/tabs/TeacherQuizPreview/StudentViewForTeacher.vue":
/*!**************************************************************************************************!*\
  !*** ./resources/js/components/Classwork_View/tabs/TeacherQuizPreview/StudentViewForTeacher.vue ***!
  \**************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/Classwork_View/tabs/TeacherQuizPreview/StudentViewForTeacher.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/Classwork_View/tabs/TeacherQuizPreview/StudentViewForTeacher.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************!*\
  !*** ./resources/js/components/Classwork_View/tabs/TeacherQuizPreview/StudentViewForTeacher.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                            ...
                            [
                              ...
                              _c(
                                ...
                                [
                                  ...
                                  _c("previewTimer", {
                                    attrs: {
                                      duration: _vm.classworkDetails.duration
                                    }
                                  })
                                ],
                                1
